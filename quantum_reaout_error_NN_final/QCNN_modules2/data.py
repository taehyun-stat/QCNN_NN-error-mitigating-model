...
# Types of data feature reduction method with specific number of features
...
# Function of data loading and processing (selecting y-label, feature reduction method)
def data_load_and_process(dataset, classes=[0, 1], feature_reduction='resize256', binary=True):
    ...
    # Choosing the number of y-labels
    if classes == 'odd_even':
        odd = [1, 3, 5, 7, 9]
        X_train = x_train
        X_test = x_test
    ...
    # Choosing feature reduction method
